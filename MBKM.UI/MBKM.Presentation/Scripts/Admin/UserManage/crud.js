        ...
        $.ajax({
            ...
            success: function (e) {
                ...
                $('#idRole').change(function () {
                    ...
                    if (selectedRole != "Kepala Program Studi" &&  selectedRole != "Admin Fakultas") {//hide fakultas selectedRole != "Kepala Program Studi" && selectedRole != "Dosen" &&
                        ...
                        if (selectedRole != "Kepala Program Studi") {//close prodi  && selectedRole != "Dosen"
                            //$('#specialRole').html('<input type="text" value="BAA" class="form-control input-pendaftaran input-data" disabled="disabled" id="specialRole" name="specialRole">')
                            $("#divProdi").prop('hidden', true);
                            //$("#specialRole").text("asd-BAA");
                            $("#specialRole").val(selectedRole);
    ...
    $.ajax({
        ...
        success: function (e) {
           ...
           // console.log($("#inp_fakultas").val());
            ...
            //if (selectedRole == "Admin Fakultas") {//admin fak only 22december
            //    $("#divProdi").prop('hidden', true);
            //    $("#divFakultas").prop('hidden', false);
