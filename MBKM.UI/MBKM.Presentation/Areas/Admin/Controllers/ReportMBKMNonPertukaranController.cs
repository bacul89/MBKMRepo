    ...
    public class ReportMBKMNonPertukaranController : Controller
    {
        ...
        public ActionResult GetFileExcel(int id)
        {
            ...
            for (int i = 0; i < result.Count; i++)
            {
                ...
                checkNilaiDiakui = _nilaiKuliahService.GetNilaiDiakui(tmp.JadwalKuliahs.JenjangStudi, tmp.JadwalKuliahs.STRM.ToString(), tmp.JadwalKuliahs.MataKuliahID, tmp.JadwalKuliahs.KodeMataKuliah, tmp.mahasiswas.NIM.ToString());
                if (checkNilaiDiakui == null)
                {
                    nilaiDiakui = "-";
                    nilaiBobotDiakui.GRADE_POINTS = "-";
                ...
                ws.Cells["O" + (i + 8)].Value = nilaiDiakui;
                ws.Cells["P" + (i + 8)].Value = nilaiBobotDiakui.GRADE_POINTS;
